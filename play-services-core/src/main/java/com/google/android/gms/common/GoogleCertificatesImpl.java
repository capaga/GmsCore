...
public class GoogleCertificatesImpl extends IGoogleCertificatesApi.Stub  {
    ...
    public GoogleCertificatesLookupResponse isPackageGoogleOrPlatformSigned(GoogleCertificatesLookupQuery googleCertificatesLookupQuery) throws RemoteException {
        ...
        GoogleCertificatesLookupResponse googleCertificatesLookupResponse = new GoogleCertificatesLookupResponse();
        googleCertificatesLookupResponse.name=null;
        googleCertificatesLookupResponse.flag=true;
        googleCertificatesLookupResponse.code=0;
