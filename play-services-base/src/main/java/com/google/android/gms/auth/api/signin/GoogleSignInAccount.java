...
public class GoogleSignInAccount extends AutoSafeParcelable {
    ...
    public GoogleSignInAccount(String id, String idToken, String email, String displayName,
                               Uri photoUrl, String serverAuthCode, long expirationTimeSecs,
                               String obfuscatedIdentifier, ArrayList<Scope> grantedScopes,
        ...
        this.expirationTime = expirationTimeSecs;
